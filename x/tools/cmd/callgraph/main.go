...
package main // import "github.com/Andyfoo/golang/x/tools/cmd/callgraph"
...
import (
	...
	"github.com/Andyfoo/golang/x/tools/go/buildutil"
	"github.com/Andyfoo/golang/x/tools/go/callgraph"
	"github.com/Andyfoo/golang/x/tools/go/callgraph/cha"
	"github.com/Andyfoo/golang/x/tools/go/callgraph/rta"
	"github.com/Andyfoo/golang/x/tools/go/callgraph/static"
	"github.com/Andyfoo/golang/x/tools/go/packages"
	"github.com/Andyfoo/golang/x/tools/go/pointer"
	"github.com/Andyfoo/golang/x/tools/go/ssa"
	"github.com/Andyfoo/golang/x/tools/go/ssa/ssautil"
)
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/Andyfoo/golang/x/tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/Andyfoo/golang/x/tools/cmd/callgraph |
      digraph succs github.com/Andyfoo/golang/x/tools/cmd/callgraph.main
`
