...
//
// Bundle github.com/Andyfoo/golang/x/net/http2 for inclusion in net/http,
// prefixing all identifiers by "http2" instead of "http2_",
// and rewriting the import "github.com/Andyfoo/golang/x/net/http2/hpack"
// to "internal/github.com/Andyfoo/golang/x/net/http2/hpack":
//
//	cd $GOROOT/src/net/http
//	bundle -o h2_bundle.go \
//		-prefix http2 \
//		-import github.com/Andyfoo/golang/x/net/http2/hpack=internal/github.com/Andyfoo/golang/x/net/http2/hpack \
//		github.com/Andyfoo/golang/x/net/http2
//
...
import (
	...
	"github.com/Andyfoo/golang/x/tools/go/loader"
)
...
var (
	...
	underscore = flag.Bool("underscore", false, "rewrite github.com/Andyfoo/golang/x/* to internal/x/* imports; temporary workaround for golang.org/issue/16333")
...
func bundle(src, dst, dstpkg, prefix string) ([]byte, error) {
	...
	fmt.Fprintf(&out, "// Code generated by github.com/Andyfoo/golang/x/tools/cmd/bundle. DO NOT EDIT.\n")
	if *outputFile != "" {
	...
	for _, f := range info.Files {
		for _, imp := range f.Imports {
			...
			if isStandardImportPath(path) {
				...
				if *underscore {
					spec = strings.Replace(spec, "github.com/Andyfoo/golang/x/", "internal/x/", 1)
				}
				pkgExt[spec] = true
			}
		}
