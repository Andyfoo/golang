...
import (
	...
	"github.com/Andyfoo/golang/x/tools/blog"
	"github.com/Andyfoo/golang/x/tools/godoc/redirect"
)

const (
	blogRepo = "github.com/Andyfoo/golang/x/blog"
...
func blogInit(host string) {
	...
	// Prefer content from the github.com/Andyfoo/golang/x/blog repository if present.
