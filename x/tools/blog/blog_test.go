...
func TestLinkRewrite(t *testing.T) {
	tests := []struct {
		...
		{
			`For instance, the <code>websocket</code> package from the <code>go.net</code> sub-repository has an import path of <code>&#34;github.com/Andyfoo/golang/x/net/websocket&#34;</code>.`,
			`For instance, the <code>websocket</code> package from the <code>go.net</code> sub-repository has an import path of <code>&#34;github.com/Andyfoo/golang/x/net/websocket&#34;</code>.`,
		},
	}
