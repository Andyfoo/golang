...
import (
	...
	"github.com/Andyfoo/golang/x/tools/internal/lsp/types" //@item(types_import, "types", "\"github.com/Andyfoo/golang/x/tools/internal/lsp/types\"", "package"),prepare("types","\"", "types")
)
