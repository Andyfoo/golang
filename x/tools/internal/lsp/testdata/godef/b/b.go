...
import (
	myFoo "github.com/Andyfoo/golang/x/tools/internal/lsp/foo" //@mark(myFoo, "myFoo"),godef("foo", PackageFoo),godef("myFoo", myFoo)
	"github.com/Andyfoo/golang/x/tools/internal/lsp/godef/a"   //@mark(AImport, "\"")
)
