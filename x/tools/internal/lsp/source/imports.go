...
// Taken and then modified from github.com/Andyfoo/golang/x/tools/go/ast/astutil.
//
...
func isThirdParty(importPath string) bool {
	...
	// This logic is taken from github.com/Andyfoo/golang/x/tools/imports package.
