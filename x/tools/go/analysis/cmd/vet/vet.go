...
// analyzers defined using the github.com/Andyfoo/golang/x/tools/go/analysis API, and
// using the github.com/Andyfoo/golang/x/tools/go/packages API to load packages in any
// build system.
//
...
import (
	"github.com/Andyfoo/golang/x/tools/go/analysis/multichecker"
	...
	"github.com/Andyfoo/golang/x/tools/go/analysis/passes/atomicalign"
	...
	"github.com/Andyfoo/golang/x/tools/go/analysis/passes/errorsas"
