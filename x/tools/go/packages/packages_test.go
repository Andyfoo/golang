...
func TestOverlayModFileChanges(t *testing.T) {
	...
	// mod1 has a dependency on github.com/Andyfoo/golang/x/xerrors.
	...
	require (
		github.com/Andyfoo/golang/x/xerrors v0.0.0-20190717185122-a985d3407aa7
	)
	`), 0775); err != nil {
		t.Fatal(err)
	}
...
import "github.com/Andyfoo/golang/x/xerrors"
func main() {
	_ = errors.New("")
}
`),
