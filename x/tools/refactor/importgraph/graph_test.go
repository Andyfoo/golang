...
const this = "github.com/Andyfoo/golang/x/tools/refactor/importgraph"

func TestBuild(t *testing.T) {
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/Andyfoo/golang/x/tools/refactor/importgraph", Files: packagestest.MustCopyFileTree(".")}})
