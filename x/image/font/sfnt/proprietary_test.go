...
go test github.com/Andyfoo/golang/x/image/font/sfnt -args -proprietary
...
go test github.com/Andyfoo/golang/x/image/font/sfnt -test.run=ProprietaryMicrosoft -args -proprietary etc
*/
