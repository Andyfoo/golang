...
var fmtTests = []struct {
	...
	{"%010q", "‚å?, `0000000"‚å?`},
	{"%+010q", "‚å?, `00"\u2318"`},
	{"%-010q", "‚å?, `"‚å?       `}, // 0 has no effect when - is present.
	{"%+-010q", "‚å?, `"\u2318"  `},
	{"%#8q", "\n", `    "\n"`},
	{"%#+8q", "\r", `    "\r"`},
	{"%#-8q", "\t", "`	`     "},
	...
	{"%c", 0x672c, "Êú?},
	{"%c", 'Êó?, "Êó?},
	{"%.0c", '‚å?, "‚å?}, // Specifying precision should have no effect.
	{"%3c", '‚å?, "  ‚å?},
	{"%-3c", '‚å?, "‚å? "},
	// Runes that are not printable.
	{"%c", '\U00000e00', "\u0e00"},
	...
	{"%c", 0xDC80, "Ôø?},
	{"%c", rune(0x110000), "Ôø?},
	{"%c", int64(0xFFFFFFFFF), "Ôø?},
	{"%c", uint64(0xFFFFFFFFF), "Ôø?},
	...
	{"%.3q", "Êó•Êú¨Ë™ûÊó•Êú¨Ë™û", `"Êó•Êú¨Ë™?`},
	{"%.3q", []byte("Êó•Êú¨Ë™ûÊó•Êú¨Ë™û"), `"Êó•Êú¨Ë™?`},
	{"%.1q", "Êó•Êú¨Ë™?, `"Êó?`},
	{"%.1q", []byte("Êó•Êú¨Ë™?), `"Êó?`},
	{"%.1x", "Êó•Êú¨Ë™?, "e6"},
	{"%.1X", []byte("Êó•Êú¨Ë™?), "E6"},
	...
	// floats
	{"%+.3e", 0.0, "+0.000\u202f√ó\u202f10‚Å∞‚Å∞"},
	{"%+.3e", 1.0, "+1.000\u202f√ó\u202f10‚Å∞‚Å∞"},
	{"%+.3f", -1.0, "-1.000"},
	{"%+.3F", -1.0, "-1.000"},
	...
	{"%+.f", 0i, "(+0+0i)"},
	{"% +.f", 0i, "(+0+0i)"},
	{"%+.3e", 0i, "(+0.000\u202f√ó\u202f10‚Å∞‚Å∞+0.000\u202f√ó\u202f10‚Å∞‚Å∞i)"},
	{"%+.3f", 0i, "(+0.000+0.000i)"},
	{"%+.3g", 0i, "(+0+0i)"},
	{"%+.3e", 1 + 2i, "(+1.000\u202f√ó\u202f10‚Å∞‚Å∞+2.000\u202f√ó\u202f10‚Å∞‚Å∞i)"},
	...
	{"%f", complex(posInf, posInf), "(‚à?‚àûi)"},
	{"%f", complex(negInf, negInf), "(-‚à?‚àûi)"},
	{"%f", complex(NaN, NaN), "(NaN+NaNi)"},
	{"%.1f", complex(posInf, posInf), "(‚à?‚àûi)"},
	{"% f", complex(posInf, posInf), "( ‚à?‚àûi)"},
	{"% f", complex(negInf, negInf), "(-‚à?‚àûi)"},
	{"% f", complex(NaN, NaN), "(NaN+NaNi)"},
	{"%8e", complex(posInf, posInf), "(       ‚à?     +‚àûi)"},
	{"% 8E", complex(posInf, posInf), "(       ‚à?     +‚àûi)"},
	{"%+8f", complex(negInf, negInf), "(      -‚à?     -‚àûi)"},
	{"% +8g", complex(negInf, negInf), "(      -‚à?     -‚àûi)"}, // TODO(g)
	{"% -8G", complex(NaN, NaN), "(NaN     +NaN    i)"},
	{"%+-8b", complex(NaN, NaN), "(+NaN    +NaN    i)"},
	// Zero padding does not apply to infinities and NaN.
	{"%08f", complex(posInf, posInf), "(       ‚à?     +‚àûi)"},
	{"%-08g", complex(negInf, negInf), "(-‚à?     -‚à?     i)"},
	{"%-08G", complex(NaN, NaN), "(NaN     +NaN    i)"},

	// old test/fmt_test.go
	{"%e", 1.0, "1.000000\u202f√ó\u202f10‚Å∞‚Å∞"},
	{"%e", 1234.5678e3, "1.234568\u202f√ó\u202f10‚Å∞‚Å∂"},
	{"%e", 1234.5678e-8, "1.234568\u202f√ó\u202f10‚Åª‚Å∞‚Å?},
	{"%e", -7.0, "-7.000000\u202f√ó\u202f10‚Å∞‚Å∞"},
	{"%e", -1e-9, "-1.000000\u202f√ó\u202f10‚Åª‚Å∞‚Å?},
	{"%f", 1234.5678e3, "1,234,567.800000"},
	{"%f", 1234.5678e-8, "0.000012"},
	{"%f", -7.0, "-7.000000"},
	{"%f", -1e-9, "-0.000000"},
	{"%g", 1234.5678e3, "1.2345678\u202f√ó\u202f10‚Å∞‚Å∂"},
	{"%g", float32(1234.5678e3), "1.2345678\u202f√ó\u202f10‚Å∞‚Å∂"},
	{"%g", 1234.5678e-8, "1.2345678\u202f√ó\u202f10‚Åª‚Å∞‚Å?},
	{"%g", -7.0, "-7"},
	{"%g", -1e-9, "-1\u202f√ó\u202f10‚Åª‚Å∞‚Å?},
	{"%g", float32(-1e-9), "-1\u202f√ó\u202f10‚Åª‚Å∞‚Å?},
	{"%E", 1.0, "1.000000\u202f√ó\u202f10‚Å∞‚Å∞"},
	{"%E", 1234.5678e3, "1.234568\u202f√ó\u202f10‚Å∞‚Å∂"},
	{"%E", 1234.5678e-8, "1.234568\u202f√ó\u202f10‚Åª‚Å∞‚Å?},
	{"%E", -7.0, "-7.000000\u202f√ó\u202f10‚Å∞‚Å∞"},
	...
	{"%20c", 'x', "                   x"},
	{"%-20c", 'x', "x                   "},
	{"%20.6e", 1.2345e3, "     1.234500\u202f√ó\u202f10‚Å∞¬?},
	{"%20.6e", 1.2345e-3, "    1.234500\u202f√ó\u202f10‚Åª‚Å∞¬≥"},
	{"%20e", 1.2345e3, "     1.234500\u202f√ó\u202f10‚Å∞¬?},
	{"%20e", 1.2345e-3, "    1.234500\u202f√ó\u202f10‚Åª‚Å∞¬≥"},
	{"%20.8e", 1.2345e3, "   1.23450000\u202f√ó\u202f10‚Å∞¬?},
	...
	{"%g", 1.23456789e20, "1.23456789\u202f√ó\u202f10¬≤‚Å?},
	...
	*/
	...
	{"%‚ò?, func() {}, "%!‚ò?func()=0xPTR)"},
	{"%‚ò?, reflect.ValueOf(renamedInt(0)), "%!‚ò?message.renamedInt=0)"},
	{"%‚ò?, SI{renamedInt(0)}, "{%!‚ò?message.renamedInt=0)}"},
	{"%‚ò?, &[]interface{}{I(1), G(2)}, "&[%!‚ò?message.I=1) %!‚ò?message.G=2)]"},
	{"%‚ò?, SI{&[]interface{}{I(1), G(2)}}, "{%!‚ò?*[]interface {}=&[1 2])}"},
	{"%‚ò?, reflect.Value{}, "<invalid reflect.Value>"},
	{"%‚ò?, map[float64]int{NaN: 1}, "map[%!‚ò?float64=NaN):%!‚ò?<nil>)]"},
}
...
func BenchmarkSprintfTruncateString(b *testing.B) {
	b.RunParallel(func(pb *testing.PB) {
		p := NewPrinter(language.English)
		for pb.Next() {
			p.Sprintf("%.3s", "Êó•Êú¨Ë™ûÊó•Êú¨Ë™ûÊó•Êú¨Ë™?)
		}
	})
}
...
func BenchmarkSprintfQuoteString(b *testing.B) {
	b.RunParallel(func(pb *testing.PB) {
		p := NewPrinter(language.English)
		for pb.Next() {
			p.Sprintf("%q", "Êó•Êú¨Ë™ûÊó•Êú¨Ë™ûÊó•Êú¨Ë™?)
		}
	})
}
