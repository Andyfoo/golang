...
import (
	...
	"github.com/Andyfoo/golang/x/text/internal/format"
...
// It implements "github.com/Andyfoo/golang/x/text/internal/format".State.
type printer struct {
	Printer
...
// Language implements "github.com/Andyfoo/golang/x/text/internal/format".State.
