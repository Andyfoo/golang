...
const printerType = "github.com/Andyfoo/golang/x/text/message.Printer"
...
func (r *rewriter) Visit(n ast.Node) ast.Visitor {
	...
	// "github.com/Andyfoo/golang/x/text/message".Printer.
...
var rewriteFuncs = map[string]map[string]rewriteType{
	// TODO: Printer -> *github.com/Andyfoo/golang/x/text/message.Printer
	"fmt": {
