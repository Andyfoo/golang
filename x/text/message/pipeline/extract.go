...
import (
	...
	fmtparser "github.com/Andyfoo/golang/x/text/internal/format"
...
func (x *extracter) seedEndpoints() error {
	pkgInfo := x.iprog.Package("github.com/Andyfoo/golang/x/text/message")
	if pkgInfo == nil {
		return errors.New("pipeline: github.com/Andyfoo/golang/x/text/message is not imported")
	}
