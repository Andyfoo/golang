...
`
	...
	copyExported("github.com/Andyfoo/golang/x/net/idna")
...
func copyExported(p string) {
	copyPackage(
		...
		"github.com/Andyfoo/golang/x/text/internal/export/"+path.Base(p),
		p)
}
...
func copyPackage(dirSrc, dirDst, search, replace string) {
	err := filepath.Walk(dirSrc, func(file string, info os.FileInfo, err error) error {
		...
		comment := "// Code generated by running \"go generate\" in github.com/Andyfoo/golang/x/text. DO NOT EDIT.\n\n"
