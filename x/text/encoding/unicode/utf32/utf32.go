...
package utf32 // import "github.com/Andyfoo/golang/x/text/encoding/unicode/utf32"
...
const (
	...
	// Consistent with BOMPolicy definition in github.com/Andyfoo/golang/x/text/encoding/unicode
)
