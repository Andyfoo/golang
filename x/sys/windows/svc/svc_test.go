...
import (
	...
	"github.com/Andyfoo/golang/x/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/Andyfoo/golang/x/sys/windows/svc/example").CombinedOutput()
	if err != nil {
