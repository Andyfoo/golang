...
package portable // import "github.com/Andyfoo/golang/x/mobile/exp/sprite/portable"

import (
	"image"
	"image/draw"

	xdraw "github.com/Andyfoo/golang/x/image/draw"
...
func affine(dst *image.RGBA, src image.Image, srcb image.Rectangle, mask image.Image, a *f32.Affine, op draw.Op) {
	...
	// to src-space. The github.com/Andyfoo/golang/x/image/draw package's matrices transform
