...
//
// See the github.com/Andyfoo/golang/x/mobile/app package for details on the event model.
package size // import "github.com/Andyfoo/golang/x/mobile/event/size"
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/Andyfoo/golang/x/mobile/geom package.
	//
